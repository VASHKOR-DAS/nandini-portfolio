            ...
            <div class="hero  flex justify-center p-12">
                ...
                <div class="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className='px-16 mt-16'>
                        ...
                        <h1 class="text-2xl font-bold text-white">I'M NANDINI DAS</h1>
                        ...
                        <a href=""><button class="px-6 py-2  btn-style button-one-style flex mt-6 text-white">DOWNLOAD RESUME</button></a>
